...
This is just a different way of visualising the above. I think it tells the broad story of migration across the overall region quite well.
```{r}
migration_clean %>% 
  select(countries_most_net_migrants, year, net_migration) %>% 
  group_by(countries_most_net_migrants, year) %>% 
